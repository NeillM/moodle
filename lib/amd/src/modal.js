...
define([
    ...
    Modal.prototype.show = function() {
        ...
        var attachedelement = 'body';

        var fullscreen = Fullscreen.getElement();
        if (fullscreen) {
            // An element on the page is open in fullscreen mode so we need to move the root element inside it.
            attachedelement = '#' + fullscreen.id;
            $(attachedelement).append(this.root);
        }
        ...
        .then(function(backdrop) {
            ...
            this.getModal().focus();
            $(attachedelement).addClass('modal-open');
    ...
    Modal.prototype.hide = function() {
        this.getBackdrop().done(function(backdrop) {
            ...
            if (!this.countOtherVisibleModals()) {
                ...
                backdrop.hide();
                $(attachedelement).removeClass('modal-open');
            }
