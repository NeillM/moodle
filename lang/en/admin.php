...
$string['searchreplacecoursesearch'] = 'Replace course search';
$string['searchreplacecoursesearch_desc'] = 'Global search can be used to replace the front page course search. You may want to disable this option if the front page course search is used to find courses that users are not enrolled on and global search is configured to only search in enrolled courses';
